...
export const DashboardCard: FC<DashboardCardProps> = ({ Icon, label, path, value }) => {
     ...
     return (
          <div
               className="shadow-xl px-5 py-2 border-primary-500 border-2 gap-10 flex items-center cursor-pointer bg-indigo-50 rounded-xl text-gray-900 hover:bg-primary-500 hover:text-white transition-all duration-300 group"
